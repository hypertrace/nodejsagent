// Based on: https://github.com/open-telemetry/opentelemetry-js/blob/main/experimental/packages/opentelemetry-instrumentation-grpc/src/clientUtils.ts
/*
...
import type { GrpcInstrumentation } from '@opentelemetry/instrumentation-grpc/build/src/instrumentation';
import type {
    GrpcClientFunc,
...
import {addMetadataToSpan, createAndAddBodyCapture} from "./GrpcJsHypertraceInstrumentation";
